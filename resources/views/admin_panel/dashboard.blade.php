...
<div class="main-content">
    <div class="main-content-inner">
        <div class="container            @php
                ...
                <div class="dashboard-left">
                    ...
                    <script>
                        ...
                        setInterval(function() {
                            ...
                            if(liveTimeEl) liveTimeEl.innerHTML = strTime;
                        }, 1000);
            ...
            @else
            <!-- CENTERED ADMIN DASHBOARD (NO EMPLOYEE LINKED) -->
            <div class="admin-welcome-container" style="display: flex; justify-content: center; align-items: center; min-height: 70vh; padding: 20px;">
                <div class="admin-welcome-card" style="background: #ffffff; border-radius: 24px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.08); padding: 60px 40px; text-align: center; max-width: 800px; width: 100%; border: 1px solid #f1f5f9; position: relative; overflow: hidden;">
                    
                    <!-- Decorative Gradient Bar at top -->
                    <div style="position: absolute; top: 0; left: 0; right: 0; height: 6px; background: linear-gradient(90deg, #10b981, #3b82f6, #6366f1);"></div>

                    <!-- Date & Time Section -->
                    <div class="datetime-wrapper" style="margin-bottom: 40px; background: #f8fafc; display: inline-block; padding: 15px 35px; border-radius: 50px; border: 1px solid #e2e8f0;">
                        <div id="adminLiveDate" style="font-size: 16px; color: #64748b; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px;">
                            {{ \Carbon\Carbon::now()->format('l, F j, Y') }}
                        </div>
                        <div id="adminLiveTime" style="font-size: 36px; font-weight: 800; color: #0f172a; font-family: 'Poppins', sans-serif; letter-spacing: -1px; line-height: 1;">
                            {{ \Carbon\Carbon::now()->format('h:i:s A') }}
                        </div>
                    </div>

                    <h1 class="welcome-title" style="font-size: 46px; font-weight: 900; color: #0f172a; margin-bottom: 15px; font-family: 'Poppins', sans-serif; line-height: 1.2;">
                        Welcome to Wijdan Exclusive Store
                    </h1>

                    <p class="welcome-subtitle" style="font-size: 22px; color: #475569; font-weight: 500; margin-bottom: 40px;">
                        Management & Reporting Dashboard
                    </p>

                    <div class="welcome-divider" style="width: 80px; height: 4px; background: #3b82f6; margin: 0 auto 40px auto; border-radius: 10px;"></div>

                    <p class="welcome-footer" style="font-size: 15px; color: #94a3b8; font-weight: 500;">
                        Developed by <strong style="color: #334155; font-weight: 700;">ProWave Software Solutions</strong>
                    </p>
                </div>
            </div>

            <script>
                // Live clock updates for centered admin dashboard
                setInterval(function() {
                    var now = new Date();
                    var hours = now.getHours();
                    var minutes = now.getMinutes();
                    ...
                    var adminTimeEl = document.getElementById('adminLiveTime');
                    if(adminTimeEl) adminTimeEl.innerHTML = strTime;
                }, 1000);
            </script>
            @endif
</div>
