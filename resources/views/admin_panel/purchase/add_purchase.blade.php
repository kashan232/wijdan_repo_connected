                    ...
                    <div class="bodywrapper__inner">
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-nowrap overflow-auto">
                            ...
                            <div class="flex-grow-1">
                                <h2 class="page-title m-0">Create Purchase</h2>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('store.Purchase') }}" method="POST">
                                            ...
                                            <div class="row mb-3 g-3 mt-4">
                                                ...
                                                <div class="col-xl-12 mt-3">
                                                    <div class="row g-3 align-items-end">
                                                        ...
                                                        {{-- TO WAREHOUSE --}}
                                                        <div class="col-xl-4 col-sm-6 d-none" id="purchaseWarehouseBox">
                                                            <label>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1 align-items-center" style="min-width:140px;">
                                                                    <!-- PKR discount (keeps existing form name item_disc[] so backend stays compatible) -->
                                                                    <input type="number" step="0.01" name="item_disc[]" class="form-control item_disc" value="" placeholder="PKR" style="width:60%;">
                                                                    <!-- Percent discount -->
                                            ...
                                            <button type="button" id="submitBtn" class="btn btn-primary mt-3 mb-3">Save Purchase</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
...
<li class="list-group-item modal-product-item"
    ...
    <br>
    <div class="mt-1"><span style="font-weight: 800; font-size: 1.3rem; color: #2563eb;">Rs: ${p.wholesale_price}</span> | <small>${p.brand ?? '-'}</small></div>
    <br>
